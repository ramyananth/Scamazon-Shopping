...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { comment: @feedback.comment, item_id: @feedback.item_id, name: @feedback.name } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { comment: @feedback.comment, item_id: @feedback.item_id, name: @feedback.name } }
